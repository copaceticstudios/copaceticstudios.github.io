...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <?php $page="gravitate"; include($_SERVER["DOCUMENT_ROOT"]."/assets/include/navbar.php"); ?>
      ...
      <div class="row">
        <div class="col-xs-10 col-xs-push-1 col-sm-4 col-sm-push-0 margin-bottom-20">
          ...
          <a id="price" href="https://itunes.apple.com/us/app/gravitate/id499441613?mt=8" class="btn btn-block btn-success btn-lg" role="button"></a>
            ...
            <div class="tab-content">
                ...
                <div id="carousel-screenshots-iphone" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="screenshots/gravitate-0.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-1.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-2.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-3.png">
                    </div>
                  </div>
              ...
              <div role="tabpanel" class="tab-pane fade" id="iPad">
                <div id="carousel-screenshots-ipad" class="carousel slide" data-ride="carousel">
                  ...
                  <div class="carousel-inner" role="listbox">
                    <div class="item active">
                      <img src="screenshots/gravitate-ipad-0.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-ipad-1.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-ipad-2.png">
                    </div>
                    <div class="item">
                      <img src="screenshots/gravitate-ipad-3.png">
                    </div>
                  </div>
    ...
    <script type="text/javascript">
      ...
      function requestInfo() {
        var request = {type: "GET", url: "https://itunes.apple.com/lookup?id=499441613", processData: true, dataType: "jsonp", async: true};
      ...
      function requestRatings() {
        var request = {type: "GET", url: "http://itunes.apple.com/rss/customerreviews/id=499441613/json", processData: true, dataType: "jsonp", async: true};
        var req = $.ajax(request);
